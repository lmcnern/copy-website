  ...
  render: function() {
    return (
      ...
      React.createElement("ol", null, 
          React.createElement("h2", null, " ", this.props.restaurant.name, " "), 
          React.createElement("p", null, " rating: ", this.props.restaurant.rating, ", ", this.props.restaurant.reviews, " reviews available,  "), 
          React.createElement("h4", null, " ", this.props.restaurant.description), 
          React.createElement("button", null, " View Menu 👍"), 
          React.createElement("p", null, this.props.restaurant.deliveryMin)
      )
      )
    )
  }
...
var RestaurantList = React.createClass({displayName: "RestaurantList",
  render: function() {
    var localRestaurant = this.props.restaurantList.map(function(restaurant) {
      return React.createElement(Restaurant, {restaurant: restaurant})
    })

   return (
     React.createElement("section", null, 
       React.createElement("h2", null, "Restaurants serving you:"), 
...
var RestaurantListContainer = React.createClass({displayName: "RestaurantListContainer",
  ...
  render: function() {
    return (
      React.createElement(RestaurantList, {restaurantList: this.state.restaurant})
    )
  }
})
...
var Footer = React.createClass({displayName: "Footer",
  render: function() {
    return (
      React.createElement("section", null, 
        React.createElement("p", null, "Site Map: San Francisco | Los Angeles | New York | Miami | Chicago | Seattle | Houston | Boston | San Diego | Washington DC | Philadelphia | Austin | Las Vegas | Jersey" + ' ' +
"City | Dallas | Denver | Atlanta | Orlando | Sacramento | Oakland | Baltimore | Berkeley | Brooklyn | Pasadena | Phoenix | Boca Raton | Minneapolis | Alexandria | All Cities "), 
React.createElement("p", null, "Cuisines: Pizza | Chinese | Indian | Thai | Sushi | All Cuisines")
      )
    )
  }
})
...
var Header = React.createClass({displayName: "Header",
  render: function() {
    return (
      React.createElement("section", null, 
        React.createElement("h1", null, "Eat24"), 
          React.createElement("h3", null, "What are you Hungry for?")
  ...
  render: function() {
    return (
      React.createElement("main", null, 
        ...
        React.createElement(RestaurantListContainer, null), 
